...
COMMON_SPEC = importlib.util.spec_from_file_location("_phase5_density_common", COMMON_PATH)
...
if __name__ == "__main__":
    run_task(
        TaskConfig(
            ...
            model_dir_name="density_pubmedbert",
            result_file_name="pubmedbert_density_results.json",
