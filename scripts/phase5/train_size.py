...
COMMON_SPEC = importlib.util.spec_from_file_location("_phase5_size_common", COMMON_PATH)
...
if __name__ == "__main__":
    run_task(
        TaskConfig(
            ...
            model_dir_name="size_pubmedbert",
            result_file_name="pubmedbert_size_results.json",
            primary_metric="f1",
            weighted_loss=False,
        )
    )
